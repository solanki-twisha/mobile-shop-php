<?php
    ...
    $pro=mysqli_query($connect,"select * from mobile where brand_id=".$_REQUEST["brand_id"]);
?>
            ...
            ?>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <!-- <div class="card-header p-0 position-relative"> -->
                                <a href="mobile_detail.php?id=<?php echo $rpro[0]; ?>">
                                    <img src="<?php echo $rpro[4]; ?>" alt="Card image cap">
                                </a>
                            <!-- </div> -->
                            <!-- <img src="images/7.png" alt="img" /> -->
                            <h3>Rs.<strong class="red"><?php echo $rpro[3]; ?></strong></h3>
                            <span><?php echo $rpro[2]; ?></span>
                ...
                ?>
                    <!-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/7.png" alt="img" />
                            <h3>Rs.<strong class="red">12,000</strong></h3>
                            <span>Redmi 9</span>
                            <i><img src="images/star.png"/></i>
                            <i><img src="images/star.png"/></i>
                            <i><img src="images/star.png"/></i>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            ...
                            <h3>Rs.<strong class="red">25,000</strong></h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            ...
                            <h3>Rs.<strong class="red">30,000</strong></h3>
                            <span>Vivo Y23</span>
                            <i><img src="images/star.png"/></i>
                            <i><img src="images/star.png"/></i>
                            <i><img src="images/star.png"/></i>
